...
function build_calendar($month, $year)
{
    ...
    while ($currentDay <= $numberDays) {
        ...
        if ($date < date('Y-m-d')) {
            ...
            $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='appointment_form.php?date=" . $date . "' class='btn btn-success btn-xs'> <span class='glyphicon glyphicon-ok'></span> Book Now</a>";
        }
