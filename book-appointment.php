...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `Patient`(`PatientId`, `Name`, `Surname`, `Age`, `Gender`, `PhoneNumber`, `MedicalAidNo`, `Image`, `PatientProfile`) 
           VALUES (NULL, '$first_name', '$last_name', '$dob', '$gender', '', '', '$image', '')";
