               ...
               <div class="tab-pane fade show active" id="receptionist" role="tabpanel" aria-labelledby="receptionist-tab">
                  <div class="container">
                     <div class="text-center mb-4">
                        <h3>Kids too must contribute at home</h3>
                        <p class="text-muted">your child is an employee</p>
                     </div>
                        ...
                        <form action="" method="post" style="width:50vw; min-width:300px;">
                           <div class="row mb-3">
                              ...
                              <div class="col">
                                 ...
                                 <input type="text" class="form-control" name="last_name" placeholder="Employee Surname">
                              </div>
                           </div>
                           ...
                           <div class="mb-3">
                              <label class="form-label">Employee Identity Number:</label>
                              <input type="text" class="form-control" name="identity_number" placeholder="Employee Identity Number">
                           </div>
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="role" placeholder="Employee Role">
                           </div>

                           <div class="mb-3">
                              <label class="form-label">Employee Race:</label>
