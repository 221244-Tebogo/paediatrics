...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `PatientForm`(`id`, `first_name`, `last_name`, `email`, `gender`) 
...
<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #0095d4;">
